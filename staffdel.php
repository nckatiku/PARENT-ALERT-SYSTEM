...
<section id="container" >
   ...
   ?>
       ...
       <div style ="padding:10px;background-color:rgb(100,100,100);margin-left:-1.2%;margin-right:-1.2%;margin-top:-1%"><h4><div class="col-md-offset-5"><span style="color:white">Delete Staff Record</span></div></div></h4><br>
										...
										<div class="col-sm-offset-3">
											<input type="submit" class="btn btn-lg btn-danger" name ="Delete" value="Delete Staff Record">
										</div>
