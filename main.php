        ...
        {  
                            ...
                            if(mysql_query($query))
             {
                      	...
                      	?>
                                         ...
                                         <div class="col-sm-10">
                   <input type="text"  id="field1" onkeyup="countChar(this)" class="form-control round-form" name ="where" value="Venue:Little Soldiers campus" />
                                    ...
                                    <input  name ="when" id="datepicker"   class="form-control round-form" required/>
                                         ...
                                         <div class="col-sm-10">  
             <input id="field2"  type="text"  class="form-control round-form" name ="note" value="Note:none" >
										...
										<span class="col-md-offset-3">    <span  id="tot" style="margin-left:-60px;margin-bottom:5px;"> </span>	<span class="col-md-offset-3"><input type="reset" class="btn btn-lg btn-danger" name ="reset" value ="Clear"></span></span>
