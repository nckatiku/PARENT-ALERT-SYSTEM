      ...
      *********************************************************************************************************************************************************** -->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
           ...
           <li>
          <a class ="active" href="simple.php">
                          <i class="fa fa-dashboard"></i>
                          <span>New Event Message</span>
                      </a>
                  </li>
        ...
        {  
                            ...
                            if(mysql_query($query))
             {
                      	...
                      	?>
                                         ...
                                         <div class="col-sm-10">
                   <input type="text" class="form-control round-form" name ="where" value="Venue:Little Soldiers campus" required>
