...
">Event Message</span>  <span class="col-md-offset-5" style="color:#fff;font-size:15px;padding:8px;box-shadow: 4px 4px 3px black;background-color:rgb(237,97,94);">Note:Message Must be of 160 characters only </h4></span>     <br> <br> Wordcount :: <div class="btn btn-warning" id="charNum"> </div>
	...
	if( isset($_POST['key']) && isset($_POST['contact']) && isset($_POST['what']) && isset($_POST['when']) && isset($_POST['where']) && isset($_POST['note']) && isset($_POST['route']))
     {
...
border-bottom-left-radius:20px;"class="btn btn-lg btn-info" name ="send" value="Send" onmouseover="ct()">
