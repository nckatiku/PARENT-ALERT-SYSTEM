  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="col-md-offset-1">
          ...
          <form class="form-horizontal style-form" action ="main2.php" style="height:950px"  method="POST">
...
<br><br>
                    ...
                    <span class="help-block">Select Promtional Route for Promotional Messaages </span>
                                          ...
                                          <article class="col-sm-3 col-md-offset-3">
                                  <h4>Date</h4>  <input type="text" name ="when" id="datepicker" onclick="return x()"  class="form-control round-form" required/>
                    ...
                    <div class="col-sm-offset-4">
                      ...
                      <span class="col-md-offset-3">  <span  id="tot" style="margin-left:-120px;margin-bottom:5px;"> </span> <span class="col-md-offset-1"> <input  style="box-shadow: 3px 3px 2px black;" type="reset" class="btn btn-lg btn-danger" name ="reset" value ="Clear"></span></span>
