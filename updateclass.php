	...
	if(isset($_POST['old_class']) && isset($_POST['new_class']))
     {
		 ...
		 echo '<article class="col-md-offset-2 col-md-10"><div class="alert alert-info"><div class="centered">Class '.$old_class.' Updated to '.$new_class.' Successfully</div></div></aricle>';
			...
			echo '<font color = "red" size="3px"><b>Warning:: You filled current class and promoting class with Wrong values Please Renter</b></font>';
						                    ...
						                    { 
                  echo '<article class="col-md-offset-2 col-md-10"><div class="alert alert-danger"><div class="centered">Warning:: Any Field  is Left Empty ... Please Re-enter</div></div></article>';
		                                     }
