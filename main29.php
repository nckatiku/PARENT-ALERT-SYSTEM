  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="col-md-offset-1">
          ...
          <form class="form-horizontal style-form" action ="main29.php"  method="POST">
                  ...
                  else if($count_num > 100 )
            {
                  ...
                  if($count_num > 100 && $count_num <= 200)
                   ...
                   {  
                    ...
                    $cont_200 = substr($cont, 1103,1022); 
...
?>
...

        {
                  ...
                  $query= "SELECT * FROM  student_info ORDER BY `class` where `class` != 'ALUMINI'";
